...
![Picture of VSCode with the application ready to build](../img/NCS/SR/USB/appli_saved.png)
...
![Picture of nRF for VSCode with the visible build configuration](../img/NCS/SR/USB/build-3.png)
